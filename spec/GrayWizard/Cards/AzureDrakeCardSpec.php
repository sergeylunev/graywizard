...
use GrayWizard\Cards\AzureDrakeCard;
use PhpSpec\ObjectBehavior;
use Prophecy\Argument;
use GrayWizard\Interfaces\CardInterface;

class AzureDrakeCardSpec extends ObjectBehavior
{
    function it_is_initializable()
    {
        $this->shouldHaveType(AzureDrakeCard::class);
    }
    
    public function it_should_return_this_card_name()
    {
        $this->getType()->shouldBeString();
        $this->getName()->shouldBe('Azure Drake');
    }
